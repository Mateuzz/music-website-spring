...
public class Authors extends TableImpl<AuthorsRecord> {
     ...
     */
    public final TableField<AuthorsRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(150).nullable(false), this, "");
    ...
    public MusicsPath musics() {
        if (_musics == null)
            _musics = new MusicsPath(this, null, Keys.MUSICS__FKDIAR1U91WFI42XMG6VFL74N56.getInverseKey());
