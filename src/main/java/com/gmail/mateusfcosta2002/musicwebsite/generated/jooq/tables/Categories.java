...
public class Categories extends TableImpl<CategoriesRecord> {
    ...
    /**
     * The column <code>public.categories.nesting</code>.
     */
    public final TableField<CategoriesRecord, Integer> NESTING = createField(DSL.name("nesting"), SQLDataType.INTEGER.nullable(false), this, "");
     ...
     */
    public final TableField<CategoriesRecord, Long> PARENT_ID = createField(DSL.name("parent_id"), SQLDataType.BIGINT, this, "");
    ...
    public List<ForeignKey<CategoriesRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CATEGORIES__FKSAOK720GSU4U2WRGBK10B5N8D);
    }
    ...
    public CategoriesPath categories() {
        if (_categories == null)
            _categories = new CategoriesPath(this, Keys.CATEGORIES__FKSAOK720GSU4U2WRGBK10B5N8D, null);
    ...
    /**
     * Get the implicit to-many join path to the <code>public.musics</code>
     * table
     */
    public MusicsPath musics() {
        if (_musics == null)
            _musics = new MusicsPath(this, null, Keys.MUSICS__FK7EHFCD0BQHA5UAT6VRO7Y5OKI.getInverseKey());
