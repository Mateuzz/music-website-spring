...
import com.gmail.mateusfcosta2002.musicwebsite.generated.jooq.tables.Authorities.AuthoritiesPath;
...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * Get the implicit to-many join path to the <code>public.authorities</code>
     * table
     */
    public AuthoritiesPath authorities() {
        if (_authorities == null)
            _authorities = new AuthoritiesPath(this, null, Keys.AUTHORITIES__FKK91UPMBUEYIM93V469WJ7B2QH.getInverseKey());
    ...
    public PlaylistsPath playlists() {
        if (_playlists == null)
            _playlists = new PlaylistsPath(this, null, Keys.PLAYLISTS__FKKW37PIXQVAP2UC094O95J8LU7.getInverseKey());
