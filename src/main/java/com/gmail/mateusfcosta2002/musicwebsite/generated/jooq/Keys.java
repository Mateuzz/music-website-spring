...
public class Keys {
    ...
    public static final UniqueKey<MusicTagsRecord> MUSIC_TAGS_PKEY = Internal.createUniqueKey(MusicTags.MUSIC_TAGS, DSL.name("music_tags_pkey"), new TableField[] { MusicTags.MUSIC_TAGS.ID }, true);
    ...
    public static final UniqueKey<MusicsTagsRecord> MUSICS_TAGS_PKEY = Internal.createUniqueKey(MusicsTags.MUSICS_TAGS, DSL.name("musics_tags_pkey"), new TableField[] { MusicsTags.MUSICS_TAGS.MUSIC_ID, MusicsTags.MUSICS_TAGS.TAGS_ID }, true);
    ...
    public static final ForeignKey<MusicsTagsRecord, MusicTagsRecord> MUSICS_TAGS__FK4I4QWSOVXBKRWJFN0UNW5NNIJ = Internal.createForeignKey(MusicsTags.MUSICS_TAGS, DSL.name("fk4i4qwsovxbkrwjfn0unw5nnij"), new TableField[] { MusicsTags.MUSICS_TAGS.TAGS_ID }, Keys.MUSIC_TAGS_PKEY, new TableField[] { MusicTags.MUSIC_TAGS.ID }, true);
    public static final ForeignKey<MusicsTagsRecord, MusicsRecord> MUSICS_TAGS__FKGO2PDEEQN31AUEGJK2B490LE6 = Internal.createForeignKey(MusicsTags.MUSICS_TAGS, DSL.name("fkgo2pdeeqn31auegjk2b490le6"), new TableField[] { MusicsTags.MUSICS_TAGS.MUSIC_ID }, Keys.MUSICS_PKEY, new TableField[] { Musics.MUSICS.ID }, true);
